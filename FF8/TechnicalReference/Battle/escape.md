...
if one monster has flag [DecreaseChanceEscape]({{site.baseurl}}/technical-reference/battle/model-sections/information-stats/#decrease-change-escape),  $$X = 16$$  
If at least one monster is alive AND has the flag [IncreaseChanceEscape]({{site.baseurl}}/technical-reference/battle/model-sections/information-stats/#increase-change-escape), $$X = 128$$  
