...
|--------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0      | 24 bytes   | Monster name in [FF8 String]({{site.baseurl}}/technical-reference/miscellaneous/ff8-string/)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| 247    | 1 byte     | [LSB] Zombie / Fly / unused / LvUp-Down Immunity / HP Hidden / Auto-Reflect / Auto-Shell / Auto-Protect [MSB]. Bit `0x04` (third from LSB) is never read by the loader — it has no effect (`setMonsterInfoFromDatInfoSection` at 0x48BBD0 is the only reader of this byte and tests every other bit)                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 248    | 3 bytes    | [Card]({{site.baseurl}}/technical-reference/list/card-list/#card-info) (drop/mod/rare mod)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 251    | 3 bytes    | [Devour]({{site.baseurl}}/technical-reference/list/devour-list/#devour-effects) (low/med/high)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| 2 byte | [AbilityID]({{site.baseurl}}/technical-reference/list/ability-list/#monster-ability)   |
...
The data is 8*2 bytes, each 2 bytes corresponding to an ID on the [Special Action list]({{site.baseurl}}/technical-reference/list/action-animation-list/)
