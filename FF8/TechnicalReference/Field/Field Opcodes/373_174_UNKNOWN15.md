...
PC handler: `SCRIPT_UNKNOWN15` (renamed `SCRIPT_UNKNOWN15_set_jump_duration` in the community IDB).

## Function addresses

| Function | Address | Description |
|---|---|---|
| `SCRIPT_UNKNOWN15` | 0x5258D0 | Field script opcode handler (verified IDA function) |
