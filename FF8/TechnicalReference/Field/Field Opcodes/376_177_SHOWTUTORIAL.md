...
PC handler: `SCRIPT_SHOWTUTORIAL`. This is the **last opcode of the PC table** (376 entries, 0x000-0x177).

## Function addresses

| Function | Address | Description |
|---|---|---|
| `SCRIPT_SHOWTUTORIAL` | 0x522030 | Field script opcode handler (verified IDA function) |
