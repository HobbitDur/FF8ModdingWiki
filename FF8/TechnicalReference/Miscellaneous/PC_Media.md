...
title: PC Media
permalink: /technical-reference/miscellaneous/pc-media/
---
...
This is the main data source for all the files in a given category. The files are either LZSed and all concatenated together.
