...
| Byte        | 292         | Current card game rules                                                                                                                                                                                                                                                                                                    |
| Byte        | 293         | Current card trade rule                                                                                                                                                                                                                                                                                                    |
...
| Byte        | 1041        | Escalating deck level for balamb card player -> Linked to CC group quest                                                                                                                                                                                                                                                   |
...
4. The field controlling restriction unlocking in Ultimecia's Castle uses this to figure out where to jump the party after they've broken a seal. It's unknown
   ...
   manually.:5. List of everything that 341 holds throughout the game:
